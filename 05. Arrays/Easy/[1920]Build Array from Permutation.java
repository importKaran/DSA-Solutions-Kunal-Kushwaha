...
//same length where ans[i] = nums[nums[i]] for each 0 <= i < nums.length and return 
//it. 
//
...
// 
//
// Related Topics Array Simulation 👍 1781 👎 213
...
class Solution {
    public int[] buildArray(int[] nums) {
        ...
        // Using O(n) space, but quicker in time
        ...
        // Using O(1) space by hashing function, but time-consuming
