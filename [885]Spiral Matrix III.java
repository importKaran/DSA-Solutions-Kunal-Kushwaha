...
// 
//
// Related Topics Array Matrix Simulation 👍 618 👎 659
...
class Solution {
    public int[][] spiralMatrixIII(int rows, int cols, int rStart, int cStart) {
        ...
        // Since in the question itself, it is mentioned that array that needs to be returned will not be considered
